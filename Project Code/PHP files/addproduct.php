...
<body>
	<div class="main">
		<div class="container" style="padding-top:3%;">
			<div class="row">
				<h1 style="text-align:center;color:#FFFFFF "><b>Add A Product<b></h1>
			</div>
		</div>
        ...
        <!-- Form Start -->
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="barcode_" class="form-control" id="exampleInputAmount" placeholder="<?php echo $barcode; ?>" disabled>
             ...
             <div class="selectOpt">
              <select name="category_">
                <option value="">Select Catagory</option>
								<!-- picking and priting category item -->
							<?php
          ...
          <button type="submit" name="add_product2" class="btn btn-primary addproduct">Add Product</button>
